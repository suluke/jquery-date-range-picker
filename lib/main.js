...
$.fn.dateRangePicker = function(opt) {
	...
	if (opt.isTouchDevice) {
		opt.functions.hoveringTooltip = false;
	}
	...
	func.registerOpenListeners(selfDom, (evt) => {
	...
	function initDatepicker(element) {
		...
		if (DaytimeSelect.addToPicker) {
			const daytimes = DaytimeSelect.addToPicker(opt, box, invalidate);
			daytime1 = daytimes[0];
			daytime2 = daytimes[1];
		}
