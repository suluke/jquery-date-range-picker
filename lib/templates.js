 ...
 * displayed at a time.
 */
const showSecondMonth = function(opt) {
					...
					<table class="month1" cellspacing="0" border="0" cellpadding="0">
						<thead>
							<tr class="caption">
								...
								<th style="width:27px;">
									${(opt.singleDate || !opt.stickyMonths ? '<button class="next"></button>' : '')}
								</th>
							</tr>
			...
			html += `<div class="gap">
					...
					<table class="month2" cellspacing="0" border="0" cellpadding="0">
						<thead>
							<tr class="caption">
								<th style="width:27px;">
									${(!opt.stickyMonths ? '<button class="prev"></button>' : '')}
								</th>
								<th colspan="${colspan}" class="month-name"></th>
								<th style="width:27px;">
			...
			for (var day = 0; day < 7; day++) {
				...
				html.push(
					`<td ${attributesCallbacks({}, opt.dayTdAttrs, today)}>
						<button ${attributesCallbacks(todayDivAttr, opt.dayDivAttrs, today)}>
